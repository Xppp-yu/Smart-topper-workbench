...
证据保管更新（2026-08-29）：上述原 tar 的临时路径已不存在；历史验证结论和原始 SHA 不变。已从此前通过 Reviewer 验收的解压树重新封装恢复包 `EXP-P7-FULL-20260820-R02-recovered-extract-20260829.tar.gz`，文件数 `2163/2163`，大小 `672,497,970` 字节，新 SHA-256 为 `19e03e5665aa7af559b4b15e21b7e989e3e947654de686a60fd2cede4c1a4f8b`。恢复包不是原 tar，不得替换原始 SHA、历史 manifest 或冻结测试合同；本次未重跑 P7 分析。
