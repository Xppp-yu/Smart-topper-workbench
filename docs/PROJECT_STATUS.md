...
| S2_B09_runprep | SLP8 PM-only 30-unit Full 运行准备与 CLI bridge | B09_RUN_PREPARATION_ACCEPTED / FULL_RUNNER_CLI_BRIDGE_ACCEPTED / GPU_FULL_NOT_AUTHORIZED / TEST_DENIED | [B09 准备任务书](tasks/TASK_SLP_B09_FULL_RUN_PREPARATION_v0.1.md)、[CLI bridge 任务书](tasks/TASK_SLP_B09_FULL_RUNNER_CLI_BRIDGE_v0.1.md)、validator；`main@8b3ebda` 独立复核：172 passed + links 6 passed，80 OK / 0 ERR，`py_compile` PASS，TEST=0 | Owner 复核并明确授权 [B09 Full 授权准备任务](tasks/TASK_SLP_B09_FULL_RUN_AUTHORIZATION_PREPARATION_v0.1.md)；未授权前不得启动 30-unit Full；TEST 继续禁止 |
