...
| S2_B08 | SLP8 PM-only Full Runner 与 one-fold preflight runner | RUNNER_IMPLEMENTATION_COMPLETE / READY_FOR_CODE_REVIEW / GPU_PREFLIGHT_NOT_RUN | 真实 B01 TRAIN+VAL fold routing、fold-TRAIN-only preprocessing/class weights、30-unit governed plan、checkpoint/resume、best-checkpoint reload OOF、per-subject/worst-subject metrics、identity/resource/terminal carriers；`--one-fold-preflight` 仅运行显式 candidate/fold/seed，强制 clean SHA 与冻结训练合同，写 timing/CUDA/reload/preflight manifest；B08 74 passed，B04/B04A core+models+links 347 passed；TEST=0 | 独立 Reviewer 接受后冻结 clean SHA 与新 EXP-ID；Owner 另行决定 RTX 4090 one-fold 授权；B09 Full 与 TEST 继续未授权 |
