...
| S2_B11F | SLP8 最终开发集拟合 runner | R01_FAILED_BEFORE_TRAINING_LOOP / RUNTIME_FIX_READY_FOR_REVIEW / GPU_NOT_AUTHORIZED / TEST_DENIED | [实现报告](stage_reports/S2_B11F_SLP8_FINAL_DEVELOPMENT_FIT_PREPARATION_v0.1.md)、[运行准备报告](stage_reports/S2_B11F_SLP8_FINAL_DEVELOPMENT_FIT_RUN_PREPARATION_v0.1.md)、[runtime 修复报告](stage_reports/S2_B11F_RUNTIME_CLASS_WEIGHT_FIX_v0.1.md)、[runtime 修复任务](tasks/TASK_SLP_B11F_RUNTIME_CLASS_WEIGHT_FIX_v0.1.md)、[配置](../configs/experiments/slp8_pm_final_development_fit_v0.1.json)；R01 在 class-weight NumPy→Torch 转换处失败、training batch=0；修复定向 40、联合 123 passed；旧 EXP/授权不可复用；TEST=0 | 独立只读复审 runtime fix；ACCEPT 后形成新 runner/bundle/EXP-ID 并重新 preflight/授权 |
